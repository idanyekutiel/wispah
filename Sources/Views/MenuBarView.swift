...
struct MenuBarView: View {
    ...
    private var incompleteSetupMenu: some View {
        Group {
            Label("Complete onboarding to enable dictation", systemImage: "list.clipboard")
            ...
            Button {
                ...
                Label("Continue Onboarding", systemImage: "arrow.right.circle")
            }
